...
4. [Обеспечьте выход в интернет для всех устройств московского и амстердамского офисов.](../../Networking/03_DHCP_DNS_NAT/README.md) 
...
8. [Настройте DHCP-сервер на SRV1–MSK для клиентов в сети LAN–MSK и DHCP-сервер на FW-AMS для сети LAN–AMS. DHCP-сервер должен передавать клиентам следующие опции:](../../Networking/03_DHCP_DNS_NAT/README.md)
   - 1. Адрес хоста
   - 2. Маску сети 
   - 3. Адрес шлюза
